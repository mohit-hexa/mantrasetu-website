...
export default function Hero2() {
  return (
    ...
    >
      ...
      <div className="absolute w-[40px] h-[40px] md:w-[150px] md:h-[150px] bottom-[-20px] md:bottom-[-70px] rotate-12 sm:block">
        <img src="/assets/flower.png" alt="flower" />
      </div>
      <div className="absolute w-[40px] h-[40px] md:w-[150px] md:h-[150px] right-0 top-[-20px] md:top-[-70px] rotate-[255deg] sm:block">
        <img src="/assets/flower.png" alt="flower" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-2 sm:py-16 md:py-20 text-center">
        {/* Guru Image */}
        ...
        {/* Text */}
        <div className="mx-auto max-w-4xl md:space-y-4 sm:space-y-5 text-base sm:text-lg leading-relaxed">
          <p className="text-[5px] md:text-lg">
        ...
        {/* CTA Button */}
        <div className="mb-2 md:mb-0 mt-3 sm:mt-8 flex justify-center">
          <a href="/bookings" className="text-[5px] md:text-sm rounded-md bg-red-600 px-5 py-2.5 sm:px-6 sm:py-3 text-white font-semibold shadow hover:bg-red-700 transition">
